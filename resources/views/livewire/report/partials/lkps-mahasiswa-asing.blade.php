<x-jet-dialog-modal wire:model="formGenerateForeignStudent">
    <x-slot name="title">
    ...
    <x-slot name="footer">
        ...
        <x-success-button class="ml-2" wire:click="submitGenerateForeignStudentLKPS()" wire:loading.attr="disabled">
            Generate Report
        </x-success-button>
    </x-slot>
</x-jet-dialog-modal>
